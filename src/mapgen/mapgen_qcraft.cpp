...
const FlagDesc flagdesc_mapgen_qcraft[] = {
	{"mountains",   MGQCRAFT_MOUNTAINS},
	{"ridges",      MGQCRAFT_RIDGES},
	{"floatlands",  MGQCRAFT_FLOATLANDS},
	{"caverns",     MGQCRAFT_CAVERNS},
	{NULL,          0}
};
...
MapgenQCraft::MapgenQCraft(MapgenQCraftParams *params, EmergeParams *emerge)
	: MapgenBasic(MAPGEN_QCRAFT, params, emerge)
{
	...
	if (spflags & MGQCRAFT_FLOATLANDS) {
		// 3D noise, 1 up, 1 down overgeneration
		noise_floatland =
...
MapgenQCraftParams::MapgenQCraftParams():
...
void MapgenQCraftParams::readParams(const Settings *settings)
{
	settings->getFlagStrNoEx("mgqcraft_spflags", spflags, flagdesc_mapgen_qcraft);
	settings->getS16NoEx("mgqcraft_mount_zero_level",       mount_zero_level);
	settings->getS16NoEx("mgqcraft_floatland_ymin",         floatland_ymin);
	settings->getS16NoEx("mgqcraft_floatland_ymax",         floatland_ymax);
	settings->getS16NoEx("mgqcraft_floatland_taper",        floatland_taper);
	settings->getFloatNoEx("mgqcraft_float_taper_exp",      float_taper_exp);
	settings->getFloatNoEx("mgqcraft_floatland_density",    floatland_density);
	settings->getS16NoEx("mgqcraft_floatland_ywater",       floatland_ywater);

	settings->getFloatNoEx("mgqcraft_cave_width",           cave_width);
	settings->getS16NoEx("mgqcraft_large_cave_depth",       large_cave_depth);
	settings->getU16NoEx("mgqcraft_small_cave_num_min",     small_cave_num_min);
	settings->getU16NoEx("mgqcraft_small_cave_num_max",     small_cave_num_max);
	settings->getU16NoEx("mgqcraft_large_cave_num_min",     large_cave_num_min);
	settings->getU16NoEx("mgqcraft_large_cave_num_max",     large_cave_num_max);
	settings->getFloatNoEx("mgqcraft_large_cave_flooded",   large_cave_flooded);
	settings->getS16NoEx("mgqcraft_cavern_limit",           cavern_limit);
	settings->getS16NoEx("mgqcraft_cavern_taper",           cavern_taper);
	settings->getFloatNoEx("mgqcraft_cavern_threshold",     cavern_threshold);
	settings->getS16NoEx("mgqcraft_dungeon_ymin",           dungeon_ymin);
	settings->getS16NoEx("mgqcraft_dungeon_ymax",           dungeon_ymax);

	settings->getNoiseParams("mgqcraft_np_terrain_base",    np_terrain_base);
	settings->getNoiseParams("mgqcraft_np_terrain_alt",     np_terrain_alt);
	settings->getNoiseParams("mgqcraft_np_terrain_persist", np_terrain_persist);
	settings->getNoiseParams("mgqcraft_np_height_select",   np_height_select);
	settings->getNoiseParams("mgqcraft_np_filler_depth",    np_filler_depth);
	settings->getNoiseParams("mgqcraft_np_mount_height",    np_mount_height);
	settings->getNoiseParams("mgqcraft_np_ridge_uwater",    np_ridge_uwater);
	settings->getNoiseParams("mgqcraft_np_mountain",        np_mountain);
	settings->getNoiseParams("mgqcraft_np_ridge",           np_ridge);
	settings->getNoiseParams("mgqcraft_np_floatland",       np_floatland);
	settings->getNoiseParams("mgqcraft_np_cavern",          np_cavern);
	settings->getNoiseParams("mgqcraft_np_cave1",           np_cave1);
	settings->getNoiseParams("mgqcraft_np_cave2",           np_cave2);
	settings->getNoiseParams("mgqcraft_np_dungeons",        np_dungeons);
}


void MapgenQCraftParams::writeParams(Settings *settings) const
{
	settings->setFlagStr("mgqcraft_spflags", spflags, flagdesc_mapgen_qcraft);
	settings->setS16("mgqcraft_mount_zero_level",           mount_zero_level);
	settings->setS16("mgqcraft_floatland_ymin",             floatland_ymin);
	settings->setS16("mgqcraft_floatland_ymax",             floatland_ymax);
	settings->setS16("mgqcraft_floatland_taper",            floatland_taper);
	settings->setFloat("mgqcraft_float_taper_exp",          float_taper_exp);
	settings->setFloat("mgqcraft_floatland_density",        floatland_density);
	settings->setS16("mgqcraft_floatland_ywater",           floatland_ywater);

	settings->setFloat("mgqcraft_cave_width",               cave_width);
	settings->setS16("mgqcraft_large_cave_depth",           large_cave_depth);
	settings->setU16("mgqcraft_small_cave_num_min",         small_cave_num_min);
	settings->setU16("mgqcraft_small_cave_num_max",         small_cave_num_max);
	settings->setU16("mgqcraft_large_cave_num_min",         large_cave_num_min);
	settings->setU16("mgqcraft_large_cave_num_max",         large_cave_num_max);
	settings->setFloat("mgqcraft_large_cave_flooded",       large_cave_flooded);
	settings->setS16("mgqcraft_cavern_limit",               cavern_limit);
	settings->setS16("mgqcraft_cavern_taper",               cavern_taper);
	settings->setFloat("mgqcraft_cavern_threshold",         cavern_threshold);
	settings->setS16("mgqcraft_dungeon_ymin",               dungeon_ymin);
	settings->setS16("mgqcraft_dungeon_ymax",               dungeon_ymax);

	settings->setNoiseParams("mgqcraft_np_terrain_base",    np_terrain_base);
	settings->setNoiseParams("mgqcraft_np_terrain_alt",     np_terrain_alt);
	settings->setNoiseParams("mgqcraft_np_terrain_persist", np_terrain_persist);
	settings->setNoiseParams("mgqcraft_np_height_select",   np_height_select);
	settings->setNoiseParams("mgqcraft_np_filler_depth",    np_filler_depth);
	settings->setNoiseParams("mgqcraft_np_mount_height",    np_mount_height);
	settings->setNoiseParams("mgqcraft_np_ridge_uwater",    np_ridge_uwater);
	settings->setNoiseParams("mgqcraft_np_mountain",        np_mountain);
	settings->setNoiseParams("mgqcraft_np_ridge",           np_ridge);
	settings->setNoiseParams("mgqcraft_np_floatland",       np_floatland);
	settings->setNoiseParams("mgqcraft_np_cavern",          np_cavern);
	settings->setNoiseParams("mgqcraft_np_cave1",           np_cave1);
	settings->setNoiseParams("mgqcraft_np_cave2",           np_cave2);
	settings->setNoiseParams("mgqcraft_np_dungeons",        np_dungeons);
}


void MapgenQCraftParams::setDefaultSettings(Settings *settings)
{
	settings->setDefault("mgqcraft_spflags", flagdesc_mapgen_qcraft,
		MGQCRAFT_MOUNTAINS | MGQCRAFT_RIDGES | MGQCRAFT_CAVERNS);
}
...
int MapgenQCraft::getSpawnLevelAtPoint(v2s16 p)
{
...
void MapgenQCraft::makeChunk(BlockMakeData *data)
{
	// Pre-conditions
	assert(data->vmanip);
	assert(data->nodedef);
	...
	bool propagate_shadow = !((spflags & MGQCRAFT_FLOATLANDS) &&
...
float MapgenQCraft::baseTerrainLevelAtPoint(s16 x, s16 z)
{
...
float MapgenQCraft::baseTerrainLevelFromMap(int index)
{
...
bool MapgenQCraft::getMountainTerrainAtPoint(s16 x, s16 y, s16 z)
{
	float mnt_h_n =
...
bool MapgenQCraft::getMountainTerrainFromMap(int idx_xyz, int idx_xz, s16 y)
{
...
bool MapgenQCraft::getRiverChannelFromMap(int idx_xyz, int idx_xz, s16 y)
{
...
bool MapgenQCraft::getFloatlandTerrainFromMap(int idx_xyz, float float_offset)
{
	return noise_floatland->result[idx_xyz] + floatland_density - float_offset >= 0.0f;
}


int MapgenQCraft::generateTerrain()
{
	...
	// simplification of condition checks in y-loop.
	bool gen_rivers = (spflags & MGQCRAFT_RIDGES) && node_max.Y >= water_level - 16 &&
		!gen_floatlands;
	if (gen_rivers) {
	...
	for (s16 x = node_min.X; x <= node_max.X; x++, index2d++) {
		...
		for (s16 y = node_min.Y - 1; y <= node_max.Y + 1;
			...
			} else if ((spflags & MGQCRAFT_MOUNTAINS) &&
