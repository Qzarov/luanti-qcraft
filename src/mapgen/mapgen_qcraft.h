...
///////////// Mapgen V7 flags
#define MGQCRAFT_MOUNTAINS   0x01
#define MGQCRAFT_RIDGES      0x02
#define MGQCRAFT_FLOATLANDS  0x04
#define MGQCRAFT_CAVERNS     0x08
#define MGQCRAFT_BIOMEREPEAT 0x10 // Now unused


extern const FlagDesc flagdesc_mapgen_qcraft[];


struct MapgenQCraftParams : public MapgenParams {
...
class MapgenQCraft : public MapgenBasic {
public:
	MapgenQCraft(MapgenQCraftParams *params, EmergeParams *emerge);
	~MapgenQCraft();

	virtual MapgenType getType() const { return MAPGEN_QCRAFT; }
